                ...
                <div className="container">
                    ...
                    <dl class="max-w-md text-gray-900 divide-y divide-gray-200  dark:divide-gray-700">
                        ...
                        <div class="flex flex-col pt-3">
                            <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Hall number</dt>
                            <dd class="text-lg font-semibold">{Hallno}</dd>
                        </div>
                        <div class="flex flex-col pt-3">
                            <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Seat No</dt>
                            <dd class="text-lg font-semibold">{Seat}</dd>
                        </div>
                    </dl>
